...
function followUpRowHTML(fu, listType, idx) {
  return `
    <div class="followup-row">
      <input type="text" class="clay-input" data-fu="${listType}" data-field="snow" data-idx="${idx}" value="${esc(fu.snow)}" placeholder="Waiting on approvals, responses, or external blockers only">
      <input type="text" class="clay-input" data-fu="${listType}" data-field="sent" data-idx="${idx}" value="${esc(fu.sent)}" placeholder="Who / what sent">
      <input type="text" class="clay-input" data-fu="${listType}" data-field="reply" data-idx="${idx}" value="${esc(fu.reply)}" placeholder="Reply needed (optional)">
